...
const translations = {
  en: {
    ...
    about: "About",
    contact: "Contact",
    heroTitle: "We Build Websites for Individuals and Small/Medium Businesses",
  ...
  nl: {
    ...
    about: "Over Ons",
    contact: "Contact",
    heroTitle: "Wij bouwen websites voor individuen en kleine/middelgrote bedrijven",
  ...
  ar: {
    ...
    about: "من نحن",
    contact: "اتصل بنا",
    heroTitle: "نحن نبني مواقع إلكترونية للأفراد والشركات الصغيرة والمتوسطة",
